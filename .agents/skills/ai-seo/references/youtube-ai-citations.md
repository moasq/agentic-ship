...
- The same "models read the text layer" logic applies to podcasts: episodes get transcribed and show notes get published, so podcast guesting can compound in AI answers.
- Video production is outside this skill. Keep this audit focused on the crawlable text layer.
