...
### Infrastructure
Not vendored — this stack deploys to managed hosting (Netlify, Vercel, or Cloudflare Workers with Convex). The upstream repository carries Docker, Kubernetes, Terraform, CI/CD, and cloud guides.
