...
| Analytics | <picture><source media="(prefers-color-scheme: dark)" srcset="../.github/assets/stack/posthog-dark.svg"><img alt="" src="../.github/assets/stack/posthog-light.svg" height="14"></picture> PostHog, Plausible, or Umami | PostHog by default with official plugin readback; Plausible and Umami for lightweight, privacy-first, cookieless tracking |
