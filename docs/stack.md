...
| Billing | <picture><source media="(prefers-color-scheme: dark)" srcset="../.github/assets/stack/stripe-dark.svg"><img alt="" src="../.github/assets/stack/stripe-light.svg" height="14"></picture> Stripe via `@convex-dev/stripe` | The browser sends a plan key, never a price or amount; entitlement renders only from the webhook-backed query, never the success redirect |
