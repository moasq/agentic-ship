...
<!-- Generated by scripts/sync-agent-config.mjs from .agents/agents/backend-builder.md. -->
...
- Read `${CLAUDE_PLUGIN_ROOT}/.agents/skills/convex-structure/SKILL.md` and only the references required by
