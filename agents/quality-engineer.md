...
<!-- Generated by scripts/sync-agent-config.mjs from .agents/agents/quality-engineer.md. -->
...
- Read `${CLAUDE_PLUGIN_ROOT}/.agents/skills/testing/SKILL.md` and follow its gate and healing procedure.
- For authored UI, read `${CLAUDE_PLUGIN_ROOT}/.agents/skills/visual-qa/SKILL.md` and the validated
